...
def rotate_backups(
    backup_dir: str, keep_days: int = 7, keep_weekly: int = 4, keep_monthly: int = 3
):
    """
...
def main():
    ...
    parser.add_argument(
        "--keep-days", type=int, default=7, help="Number of daily backups to keep"
    )
    parser.add_argument(
        "--keep-weekly", type=int, default=4, help="Number of weekly backups to keep"
    )
    parser.add_argument(
        "--keep-monthly", type=int, default=3, help="Number of monthly backups to keep"
    )
    ...
    try:
        ...
        if args.rotate:
            rotate_backups(
                args.backup_dir, args.keep_days, args.keep_weekly, args.keep_monthly
            )
