...
async def demo_postgres_connector():
    ...
    try:
        ...
        try:
            ...
            logger.info(
                "💡 To test PostgreSQL, start the test database with: make docker-up"
            )
    ...
    try:
        ...
        checks = [
            ...
            },
            {
                "name": "freshness",
                "status": "passed",
                "message": "Data is fresh (last update: 2 hours ago)",
            },
            {
                "name": "schema",
                "status": "passed",
        ...
        anomalies = [
            {
                "type": "outlier",
                "severity": "medium",
                "description": "ML model detected 3 outliers in amount column",
            },
            {
                "type": "schema_change",
                "severity": "high",
                "description": "Column 'user_id' type changed from INT to UUID",
            },
            {
                "type": "data_freshness",
                "severity": "low",
                "description": "Data is 6 hours old (threshold: 4 hours)",
            },
        ]
