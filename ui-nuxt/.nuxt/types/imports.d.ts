...
declare global {
  ...
  const useStaves: typeof import('../../composables/useStaves').useStaves
...
declare global {
  ...
  // @ts-ignore
  export type { User, LoginCredentials, LoginResult } from '../../stores/auth'
  import('../../stores/auth')
}
...
declare module 'vue' {
  interface ComponentCustomProperties {
    ...
    readonly useStaves: UnwrapRef<typeof import('../../composables/useStaves')['useStaves']>
