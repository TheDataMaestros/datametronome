...
class TestReloadResult:
    ...
    def test_reload_result_success(self):
        ...
        result = ReloadResult(
            success=True, file_path="/test.yaml", staves_count=2, clefs_count=3
        )
    ...
    def test_reload_result_failure(self):
        ...
        result = ReloadResult(
            success=False, file_path="/test.yaml", error="Invalid YAML syntax"
        )
...
class TestYAMLWatcherIntegration:
    ...
    def test_file_change_detection(self, tmp_path):
        ...
        def mock_callback(file_path):
            ...
            return ReloadResult(
                success=True, file_path=file_path, staves_count=0, clefs_count=0
            )
