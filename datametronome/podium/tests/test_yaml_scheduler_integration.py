...
from datametronome_podium.services.scheduler_persistence import create_scheduler_job, get_scheduler_job_by_clef_id
...
class TestSchedulerPersistenceIntegration:
    ...
    async def test_job_persistence_flow(self):
        ...
        with patch('datametronome_podium.services.scheduler_persistence.get_db') as mock_get_db:
            ...
            from datametronome_podium.services.scheduler_persistence import get_scheduler_job
