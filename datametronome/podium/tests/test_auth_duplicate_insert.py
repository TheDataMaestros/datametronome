"""Unit tests for user-insert duplicate-key detection."""
...
def test_pg_sqlstate_23505_on_wrapped_exception() -> None:
    ...
    assert is_duplicate_user_insert(Fake23505())
