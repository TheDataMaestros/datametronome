...
class TestYAMLValidation:
    ...
    def test_validate_nested_format(self):
        ...
        yaml_data = {
            ...
            "clef": {
                "stave_id": "stave-001",
                "checks": [{"check": "row_count", "name": "Test Check"}],
            },
        }
...
class TestEnvironmentInterpolation:
    ...
    def test_interpolate_simple_var(self, monkeypatch):
        ...
        data = {"connection_config": {"host": "${DB_HOST}", "port": 5432}}
    ...
    def test_interpolate_with_default(self, monkeypatch):
        ...
        data = {"connection_config": {"ssl_mode": "${SSL_MODE:-require}"}}
    ...
    def test_interpolate_missing_required_var(self):
        ...
        data = {"connection_config": {"password": "${REQUIRED_PASSWORD}"}}
    ...
    def test_validate_required_vars(self, monkeypatch):
        ...
        data = {
            "connection_config": {"host": "${DB_HOST}", "password": "${DB_PASSWORD}"}
        }
...
class TestYAMLLoaderIntegration:
    ...
    def test_load_tdd_compliant_yaml(self):
        ...
        try:
            ...
            pytest.skip("Example file has YAML syntax errors")  # ty: ignore[too-many-positional-arguments, invalid-argument-type]
