...
from datametronome_podium.models.clef import Clef, TIER_1_CHECKS, TIER_2_CHECKS, TIER_3_CHECKS, TIER_4_CHECKS, CHECK_TIER_MAPPING
from datametronome_podium.models.severity import SeverityLevel, SeverityThreshold, evaluate_severity
from datametronome_podium.services.clef_executor import ClefExecutor, CheckResult
...
class TestTieredChecksExamples:
    ...
    def test_tier_1_simple_declarative_checks(self):
        ...
        tier_1_clefs = [
            ...
            Clef(
                ...
                config={"table": "users", "column": "email", "pattern": "^[a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,}$"},
    ...
    def test_tier_2_advanced_declarative_checks(self):
        ...
        analytics_stave = Stave(
            ...
            data_source_type="postgres",
            connection_config={"host": "analytics.example.com", "database": "analytics"}
        )
        ...
        tier_2_clefs = [
            Clef(
                ...
                config={
                    "source_a": {"type": "stave-users", "query": "SELECT COUNT(*) as total FROM users"},
                    "source_b": {"type": "stave-api", "query": {"endpoint": "/users/count"}},
                    "strategy": {"type": "field_match", "field": "total", "tolerance": 0.01}
                },
            ...
            Clef(
                ...
                config={"table": "users", "column": "last_updated", "max_age_hours": 24},
            ...
            Clef(
                ...
                config={
                    ...
                    "expected_types": {"id": "integer", "email": "varchar", "age": "integer"}
                },
    ...
    def test_tier_3_intelligent_checks(self):
        ...
        print(f"   Purpose: Proactive, stateful monitoring that learns from historical data")
    ...
    def test_tier_4_custom_python_checks(self):
        ...
        print(f"   Purpose: Implementing any business rule that is too complex for declarative checks")
...
class TestSeveritySystemExamples:
    ...
    def test_severity_levels_basic(self):
        ...
        print(f"   📊 Priority order: {harmony.priority} < {dissonance.priority} < {cacophony.priority}")
    ...
    def test_severity_thresholds_examples(self):
        ...
        lenient = SeverityThreshold(
            dissonance_condition="> 10%",
            cacophony_condition="> 50%"
        )
        ...
        for value in test_values:
            ...
            print(f"   {value:.1%}: Conservative={conservative_result.icon}, Moderate={moderate_result.icon}, Lenient={lenient_result.icon}")
    ...
    def test_severity_evaluation_examples(self):
        ...
        print(f"   📊 NULL Check (8% NULLs): {null_severity} - {null_severity.description}")
        
        # Example 2: Volume check
        user_count = 150  # 150 users registered today
        volume_severity = evaluate_severity(
            value=user_count,
            dissonance_condition="> 500",
            cacophony_condition="< 100"
        )
        print(f"   📊 Volume Check (150 users): {volume_severity} - {volume_severity.description}")
        ...
        print(f"   📊 Range Check (25% violations): {range_severity} - {range_severity.description}")
        ...
        print(f"   📊 Uniqueness Check (3 duplicates): {duplicate_severity} - {duplicate_severity.description}")
    ...
    def test_check_result_with_severity_examples(self):
        ...
        results = [
            ...
            CheckResult(
                ...
                details={"actual_count": 5100, "expected_range": {"min": 100, "max": 5000}},
            ...
            CheckResult(
                ...
                details={"out_of_range_rows": 25, "total_rows": 100, "violation_percentage": 0.25},
    ...
    def test_executor_stats_with_severity(self):
        ...
        results = [
            CheckResult("clef-1", "stave-1", SeverityLevel.HARMONY, "Pass", {}, 0.1, datetime.now()),
            CheckResult("clef-2", "stave-1", SeverityLevel.HARMONY, "Pass", {}, 0.2, datetime.now()),
            CheckResult("clef-3", "stave-1", SeverityLevel.DISSONANCE, "Warning", {}, 0.3, datetime.now()),
            CheckResult("clef-4", "stave-1", SeverityLevel.CACOPHONY, "Critical", {}, 0.4, datetime.now()),
            CheckResult("clef-5", "stave-1", SeverityLevel.HARMONY, "Pass", {}, 0.5, datetime.now())
        ]
        ...
        print(f"      ⚠️ Dissonance: {stats['dissonance']} ({stats['dissonance_rate']:.1%})")
        print(f"      ❌ Cacophony: {stats['cacophony']} ({stats['cacophony_rate']:.1%})")
...
class TestTieredChecksIntegrationExamples:
    ...
    def test_tier_progression_example(self):
        ...
        tier_1_checks = ["null_check", "range_check", "volume_check", "uniqueness_check"]
        ...
        tier_2_checks = ["reconciliation", "freshness_check", "schema_check", "lookup_validation"]
    ...
    def test_severity_configuration_examples(self):
        ...
        for name, config in [("Financial", financial_config), ("Marketing", marketing_config), ("Experimental", experimental_config)]:
    ...
    def test_complete_data_quality_pipeline_example(self):
        ...
        for tier, count in tier_counts.items():
            if count > 0:
                tier_desc = ["", "Simple Declarative", "Advanced Declarative", "Intelligent (ML-Driven)", "Custom Python"][tier]
