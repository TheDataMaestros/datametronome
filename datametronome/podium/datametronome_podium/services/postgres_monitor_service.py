...
class PostgresMonitorService:
    ...
    async def check_row_count(
        self, table_name: str, expected_min: int = 0
    ) -> Dict[str, Any]:
    ...
    async def check_data_freshness(
        self, table_name: str, timestamp_column: str, max_age_hours: int
    ) -> Dict[str, Any]:
    ...
    async def check_anomalies(
        self, table_name: str, anomaly_checks: List[Dict[str, Any]]
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            for check in anomaly_checks:
                ...
                if anomaly_count > expected_max:
                    status = (
                        "critical" if anomaly_count > expected_max * 2 else "warning"
                    )
    ...
    async def run_comprehensive_check(
        ...
        overall_results: Dict[str, Any] = {
            ...
            "overall_status": "pass",
            "table_results": [],
            "summary": {"pass": 0, "warning": 0, "critical": 0, "error": 0},
        }
