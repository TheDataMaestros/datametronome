    ...
    try:
        ...
        for exec in executions:
            execution_data.append({
                ...
                "completed_at": exec.completed_at.isoformat() + "Z" if exec.completed_at else None
            })
...
async def get_job_health(job_id: str, lookback_days: int = Query(30, ge=1, le=365)) -> Dict[str, Any]:
    """
    ...
    """
    try:
        metrics = await calculate_job_health_metrics(job_id, lookback_days=lookback_days)
    ...
    try:
        ...
        return {
            ...
            "stats": {
                ...
                "overall_success_rate": (total_executions - total_failures) / total_executions if total_executions > 0 else 1.0
            },
...
async def pause_job(job_id: str) -> Dict[str, Any]:
    ...
    try:
        ...
        if persisted_job:
            ...
            from datametronome_podium.services.scheduler_persistence import save_scheduler_job
