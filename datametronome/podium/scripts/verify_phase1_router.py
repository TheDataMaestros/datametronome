...
def main():
    ...
    if args.dry_run:
        from datametronome_podium.services.intent_router import (  # ty: ignore[unresolved-import]
            classify_intent,
        ...
        from datametronome_podium.services.orchestrator import plan_orchestration  # ty: ignore[unresolved-import]
