...
from datametronome_podium.services.stave_yaml_loader import load_staves_from_yaml, validate_yaml_config
...
async def main():
    ...
    print("=" * 30)
    print(f"✅ Successfully loaded: {successful_loads}/{len(demo_configs)} configurations")
