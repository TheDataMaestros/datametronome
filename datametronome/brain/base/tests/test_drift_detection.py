...
class TestDriftDetector:
    ...
    def test_kolmogorov_smirnov_with_series(self, detector, baseline_data):
        ...
        current_series = pd.Series(baseline_data + np.random.normal(0, 1, len(baseline_data)))
    ...
    def test_kolmogorov_smirnov_different_critical_values(self, detector, baseline_data, drifted_data):
    ...
    def test_kolmogorov_smirnov_alternatives(self, detector, baseline_data, drifted_data):
